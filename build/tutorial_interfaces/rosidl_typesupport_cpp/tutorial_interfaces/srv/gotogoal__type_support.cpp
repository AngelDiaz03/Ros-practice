...
static const _Gotogoal_Request_type_support_symbol_names_t _Gotogoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, Gotogoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, Gotogoal_Request)),
  }
};
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::Gotogoal_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tutorial_interfaces, srv, Gotogoal_Request)() {
  return get_message_type_support_handle<tutorial_interfaces::srv::Gotogoal_Request>();
}
...
static const _Gotogoal_Response_type_support_symbol_names_t _Gotogoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, Gotogoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, Gotogoal_Response)),
  }
};
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::Gotogoal_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tutorial_interfaces, srv, Gotogoal_Response)() {
  return get_message_type_support_handle<tutorial_interfaces::srv::Gotogoal_Response>();
}
...
static const _Gotogoal_type_support_symbol_names_t _Gotogoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, Gotogoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, Gotogoal)),
  }
};
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::Gotogoal_service_type_support_handle;
}
